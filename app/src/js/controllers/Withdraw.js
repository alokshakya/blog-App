CApp.controller("Withdraw", function ($scope, $http, $templateCache) {
     $scope.dep={};
   ...
   //write function for validating then run function only when validations are correct
     $scope.dep.submitForm = function() {
      ...
      $http({method: 'POST', url: '/ABC_Retail_Banking/withdraw',data: { account_ID: data1.account_ID, amount: data1.amount }, cache: $templateCache}).
